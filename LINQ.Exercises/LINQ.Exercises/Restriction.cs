...
namespace LINQ.Exercises
{
    ...
    public class Restriction
    {
        ...
        {
            IEnumerable<int> result = TestData.Numbers.Where((number, index) => index % 2 == 0);
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.Length < 5);
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.Length == 9);
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s[1] == 'i');
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.Contains('e'));

            Assert.IsTrue(new[] { "tiger", "penguin", "elephant" }.SequenceEqual(result));
        }

        [TestMethod]
        public void Where_string_ends_with_lowercase_t()
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.EndsWith("t"));
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.Contains("io"));
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p => p.FirstName[0] == p.LastName[0]);
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p => p.Born.Year < 1990);
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p => p.Born.Day % 2 == 0);
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p => p.Born.DayOfWeek == DayOfWeek.Monday && p.Born.Day == 21);
        ...
        public void Where_person_had_18_years_or_more_in_2000()
        {
            ...
            IEnumerable<TestData.Person> result = TestData.People.Where(p=> year2000.Year - p.Born.Year >=18);
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p=>p.LastName.Contains("ll")
            && p.Born.Year + p.Born.Month + p.Born.Day > 2000);
